...
/*Фрагмент был создан для добавления в программу функции "трекинг-прогресса".
  Однако, функция будет реализована лишь в следующих версиях или не реализована вовсе.
