...
/*Фрагмент был создан для добавления в программу функции "фитнес-калькулятор".
  Однако, функция будет реализована лишь в следующих версиях.
  В настоящее время реализованой логики здесь нет, лишь болванка, которая была по умолчанию*/
 ...
 * {@link FragmentCalculator.OnFragmentInteractionListener} interface
